                            ...
                            <table class="table table-striped table-hover">
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        String show = request.getSession().getAttribute("show").toString();

                                        if (show.equals("inbox")) {
                                            emails.addAll(user.getInbox());
                                ...
                                <td><span class="badge"><% out.print(emails.get(i).getEmailDateTime()); %></span> </td>
                                    ...
                                    } else if (show.equals("archive")) {
                                        emails.addAll(user.getArchive());
                                        for (int i = 0; i < emails.size(); i++) {
                                    %>
